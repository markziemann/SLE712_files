...
Source: https://github.com/markziemann/SLE712_files/blob/master/assessment_task3/assessment_task3_writing_guide.md
...
5. The codebase used to generate the report contains significant contributions from all group members including multiple commits AND issues.

6. The GitHub repository contains a properly formed README that documents the codebase purpose and contents so that someone not familiar with this unit can understand.

7. Do not commit/push the final version to GitHub as but this goes against the "Evidence of team coding and version control" criterion.
