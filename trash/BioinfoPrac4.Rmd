...
SOTS <- seqinr::read.fasta("SOTS_2020-03-27.fa") 
str(SOTS)
sots <- SOTS[[1]]
sots[1:50]
str(sots)
...
aln <- Biostrings::pairwiseAlignment(tophit_orf_aas[[1]],sots_orf_aas[[1]])
# percent identity
pid(aln)
...
ORF3a_mut <- mutator(myseq=ORF3a,150)
res <- myblastn_tab(myseq = ORF3a_mut, db = "ORF3a.fa")
res

ORF3a_mut <- mutator(myseq=ORF3a,175)
res <- myblastn_tab(myseq = ORF3a_mut, db = "ORF3a.fa")
res
